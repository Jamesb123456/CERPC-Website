...
export const commandStructureData = {
  ...
  chiefSuperintendents: [
    ...
    },
    {
      ...
      color: '#6b7280',
      rankImage: '/assets/ranks/CHIEF SUPERINTENDENT.png',
      responsibilities: ['Community engagement', 'Public relations', 'Neighborhood policing'],
    },
  ],
  ...
  inspectors: [
    ...
    },
    {
      ...
      responsibilities: ['Frontline supervision', 'Shift management', 'Patrol oversight'],
    },
    {
      id: 'chief-netops',
      name: 'Chief Inspector',
    ...
    },
    {
      ...
      color: '#dc2626',
      parent: 'chief-netops',
      responsibilities: ['Unit 19 operations', 'Specialized missions', 'Tactical support'],
    },
    {
      id: 'tactical-manager',
